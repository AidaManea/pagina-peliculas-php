...
try {
    ...
    if ($vistaRow) {
        ...
        $ins = $conn->prepare("INSERT INTO favoritas (titulo, genero, director, duracion, descripcion, valoracion, año, imagen) VALUES (:titulo, :genero, :director, :duracion, :descripcion, :valoracion, :anio, :imagen)");
